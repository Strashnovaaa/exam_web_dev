...
function updateRouteTable(page) {
    ...
    //добавление маршрутов на сайт от start до end индекса
    ...
    //выделить зелёным выбранный маршрут, если он есть
...
async function updatePrice() {
    ...
    let optionFirst = document.getElementById('option-1').checked ? 0.75 : 1;
